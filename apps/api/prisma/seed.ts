  ...
  const productData = [
    {
      ...
      sku: 'CPU-AMD-7950X',
      description: '16-core, 32-thread desktop processor with Zen 4 architecture',
      price: 18900,
      stock: 25,
      warrantyMonths: 36,
      categorySlug: 'cpu',
    ...
    },
    {
      ...
      description: '24-core, 32-thread desktop processor with hybrid architecture',
      price: 19500,
      stock: 20,
      warrantyMonths: 36,
      categorySlug: 'cpu',
    ...
    },
    {
      ...
      sku: 'GPU-NV-4090',
      description: 'Flagship graphics card with 24GB GDDR6X and Ada Lovelace architecture',
      price: 62900,
      stock: 10,
      warrantyMonths: 36,
      categorySlug: 'gpu',
    ...
    },
    {
      ...
      sku: 'GPU-AMD-7900XTX',
      description: 'High-end graphics card with 24GB GDDR6 and RDNA 3 architecture',
      price: 35900,
      stock: 15,
      warrantyMonths: 36,
      categorySlug: 'gpu',
    ...
    },
    {
      ...
      description: '32GB (2x16GB) DDR5 kit at 6000MHz with Intel XMP 3.0 support',
      price: 4290,
      stock: 50,
      warrantyMonths: 120,
      categorySlug: 'ram',

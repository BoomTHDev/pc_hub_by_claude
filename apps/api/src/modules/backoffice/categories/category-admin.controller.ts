...
export async function create(req: Request, res: Response): Promise<void> {
  ...
  const category = await categoryAdminService.createCategory(body);
...
export async function update(req: Request, res: Response): Promise<void> {
  ...
  const category = await categoryAdminService.updateCategory(categoryId, body);
...
export async function toggleActive(req: Request, res: Response): Promise<void> {
  const { categoryId } = categoryIdParamSchema.parse(req.params);
  const result = await categoryAdminService.toggleActive(categoryId);

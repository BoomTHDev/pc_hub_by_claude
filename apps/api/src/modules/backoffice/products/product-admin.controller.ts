...
export async function create(req: Request, res: Response): Promise<void> {
  ...
  const product = await productAdminService.createProduct(body);
...
export async function update(req: Request, res: Response): Promise<void> {
  ...
  const product = await productAdminService.updateProduct(productId, body);
...
export async function toggleActive(req: Request, res: Response): Promise<void> {
  const { productId } = productIdParamSchema.parse(req.params);
  const result = await productAdminService.toggleActive(productId);
...
export async function deleteImage(req: Request, res: Response): Promise<void> {
  ...
  await productAdminService.deleteProductImage(productId, imageId);
